...
public class ElNinoPageNew {

    //ElNino page elements for registration
    private final SelenideElement firstNameField = $x("//input[@name='first_name']");
    private final SelenideElement lastNameField = $x("//input[@name='last_name']");
    private final SelenideElement emailField = $x("//input[@name='email']");
    private final SelenideElement phoneNumberField = $x("//input[@name='phone_number']");
